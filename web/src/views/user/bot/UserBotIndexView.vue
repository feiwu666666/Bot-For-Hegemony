                        ...
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-model="botadd.description" class="form-control" id="add-bot-description" rows="3" placeholder="请输入Bot的描述"></textarea>
                                </div>
                                <div class="mb-3">
            ...
            $.ajax({
                ...
                success(resp){
                    if(resp.error_message === "success"){
                        ...
                        refresh_bots();
                        // Modal.getInstance("#add-bot").hide();  // 隐藏状态框
                    }else{
